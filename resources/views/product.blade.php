    ...
    <div class="product-info">
        <div class="main-block col s12">
            ...
            <div class="buy-block col s12 m12 l3" data-step="5"
                 data-intro="В конечном итоге, если товар вам подходит - вы можете посмотреть, сколько он стоить и купить его в данном блоке. Спасибо, что посмотрели тур по сайту. Удачи вам в приобритении товаров в нашем магазине..">
